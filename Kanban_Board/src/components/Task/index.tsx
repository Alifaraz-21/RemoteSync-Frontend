...
import { IoTimeOutline } from "react-icons/io5";  // or Material Icons version
...
const Task = ({ task, provided }: TaskProps) => {
    ...
    <IoTimeOutline
        color={"#666"}  // You can set the color as desired
        size={19}       // Use size instead of width and height for react-icons
    />
